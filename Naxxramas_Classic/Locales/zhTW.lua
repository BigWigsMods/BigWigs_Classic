...
if L then
	...
	L[16062] = "莫格萊尼公爵" -- Surname of Highlord Mograine
	L[16063] = "札里克爵士" -- Surname of Sir Zeliek
	L[16064] = "寇斯艾茲族長" -- Surname of Thane Korth'azz
	L[16065] = "布洛莫斯爵士" -- Surname of Lady Blaumeux
end
