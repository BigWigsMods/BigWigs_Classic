...
L = BigWigs:NewBossLocale("Gelihast Discovery", "esES")
if L then
	L.bossName = "Gelihast"
end

L = BigWigs:NewBossLocale("Lorgus Jett Discovery", "esES")
if L then
...
L = BigWigs:NewBossLocale("Twilight Lord Kelris Discovery", "esES")
if L then
...
L = BigWigs:NewBossLocale("Thunderaan Season of Discovery", "esES")
if L then
...
L = BigWigs:NewBossLocale("Grubbis Discovery", "esES")
if L then
	L.bossName = "Grubbis"
...
L = BigWigs:NewBossLocale("Emeriss Season of Discovery", "esES")
if L then
	L.bossName = "Emeriss"
end
...
L = BigWigs:NewBossLocale("Balnazzar Scarlet Enclave", "esES")
if L then
	--L.bossName = "Balnazzar"
end

L = BigWigs:NewBossLocale("High Commander Beatrix", "esES")
if L then
...
L = BigWigs:NewBossLocale("Solistrasza", "esES")
if L then
...
L = BigWigs:NewBossLocale("Grand Crusader Caldoran", "esES")
if L then
...
L = BigWigs:NewBossLocale("Azuregos Season of Discovery", "esES")
if L then
	L.bossName = "Azuregos"
end
...
L = BigWigs:NewBossLocale("Atal'alarion Discovery", "esES")
if L then
	--L.bossName = "Atal'alarion"
end

L = BigWigs:NewBossLocale("Festering Rotslime Discovery", "esES")
if L then
	--L.bossName = "Festering Rotslime"
end

L = BigWigs:NewBossLocale("Atal'ai Defenders Discovery", "esES")
if L then
	--L.bossName = "Atal'ai Defenders"
end

L = BigWigs:NewBossLocale("Dreamscythe and Weaver Discovery", "esES")
if L then
	--L.bossName = "Dreamscythe and Weaver"
end

L = BigWigs:NewBossLocale("Avatar of Hakkar Discovery", "esES")
if L then
	--L.bossName = "Avatar of Hakkar"
end

L = BigWigs:NewBossLocale("Jammal'an and Ogom Discovery", "esES")
if L then
	--L.bossName = "Jammal'an and Ogom"
end

L = BigWigs:NewBossLocale("Morphaz and Hazzas Discovery", "esES")
if L then
	--L.bossName = "Morphaz and Hazzas"
end

L = BigWigs:NewBossLocale("Shade of Eranikus Discovery", "esES")
if L then
...
L = BigWigs:NewBossLocale("Lord Kazzak Season of Discovery", "esES")
if L then
...
L = BigWigs:NewBossLocale("Azuregos", "esES")
if L then
	L.bossName = "Azuregos"
end
