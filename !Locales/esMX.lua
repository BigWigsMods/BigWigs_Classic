...
L = BigWigs:NewBossLocale("Ayamiss the Hunter", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Viscidus", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Razorgore the Untamed", "esMX")
if L then
...
if L then
	L.submerge_trigger = "¡ACÉRQUENSE, SIRVIENTES MÍOS!"
